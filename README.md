...
- Day 9 — Input Validation & Security Hardening: implemented request validation using Pydantic, added input sanitization to reduce XSS risks, configured CORS and rate limiting for API protection, and strengthened application security while using SQLAlchemy ORM to prevent SQL Injection through parameterized queries.